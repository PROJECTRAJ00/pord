...
(function () {
  ...
  <div class="topbar">
    <div class="container topbar-content">
      ...
      <div><i class="fa-solid fa-location-dot"></i> ${C.ADDRESS}</div>
    </div>
  </div>
  <header>
  ...
  <footer>
    <div class="container footer-grid">
      <div class="footer-col">
        <h4>${C.FIRM_NAME}</h4>
        <p style="margin-top:10px; font-size:14px; line-height:1.7;">Premium rooftop solar installations and wholesale solar hardware supply across Bikaner division. PM Surya Ghar Yojana registered vendor.</p>
      </div>
      <div class="footer-col">
        <h4>Quick Links</h4>
