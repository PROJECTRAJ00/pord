...
(function () {
  ...
  <div class="topbar">
    <div class="container topbar-content">
      ...
      <div class="topbar-addr"><i class="fa-solid fa-location-dot"></i> G.S. Road, Bikaner, Rajasthan 334001</div>
    </div>
  </div>
  <header>
    <div class="container navbar">
      ...
      <nav><button class="nav-close" aria-label="Close menu"><i class="fa-solid fa-xmark"></i></button><ul>${navHTML}</ul>
        <div class="nav-mobile-actions">
          <a class="btn-wa" href="https://wa.me/${C.WHATSAPP}" target="_blank" rel="noopener"><i class="fa-brands fa-whatsapp"></i> WhatsApp</a>
          <a class="btn-call" href="tel:${C.PHONE.replace(/\s/g, "")}"><i class="fa-solid fa-phone"></i> Call Now</a>
        </div>
      </nav>
  ...
  <footer>
    <div class="container footer-grid">
      <div class="footer-col">
        <h4>${C.FIRM_NAME}</h4>
        <p style="margin-top:10px; font-size:14px; line-height:1.7;">On-grid and off-grid solar installations for residential and commercial properties, plus wholesale solar hardware supply across Bikaner division. PM Surya Ghar Yojana registered vendor.</p>
      </div>
      <div class="footer-col">
        <h4>Quick Links</h4>
  ...
  // ---- Mobile menu logic (header ab inject ho chuka hai, elements exist karte hain) ----
  ...
  // Koi bhi nav link click ho to menu band ho jaye
